...
student_factors_sec <- security[, c("visitor_badge", "require_check", "random_check", "random_sweep", "drug_testing", "wear_uniform", "dress_code", "book_bags", "student_id", "prohibit_phone", "emergency_notif", "anonymous_report", "radio", "staff_id")]

management_factors_sec <- security[, c("control_building", "control_ground", "lock_inside", "close_lunch", "school_lockers", "panic_button", "security_camera")]

fa.parallel(student_factors_sec, cor='tet', fa = 'fa')

student_factors_sec_fa = fa(student_factors_sec, nfactors =6, cor='tet')
