...
student_factors_sec <- security[, c("visitor_badge", "require_check", "random_check", "random_sweep", "drug_testing", "wear_uniform", "dress_code", "book_bags", "student_id", "prohibit_phone")]

management_factors_sec <- security[, c("control_building", "control_ground", "lock_inside", "close_lunch", "school_lockers", "panic_button", "emergency_notif", "anonymous_report", "security_camera", "radio", "staff_id")]

fa.parallel(student_factors_sec, cor='tet', fa = 'fa')

student_factors_sec_fa = fa(student_factors_sec, nfactors =3, cor='tet')

print(student_factors_sec_fa$loadings, cutoff = 0.3)

fa.parallel(management_factors_sec, cor='tet', fa = 'fa')

management_factors_sec_fa = fa(management_factors_sec, nfactors =4,cor='tet')
...
parental <- parental_community[1:5]

fa.parallel(parental, cor='mixed', fa = 'fa') 

factor_parents = fa(parental, nfactors =2, rotate = "oblimin", cor = 'mixed')
...
factor_community = fa(community, nfactors =2, rotate = "oblimin", cor='tet')
